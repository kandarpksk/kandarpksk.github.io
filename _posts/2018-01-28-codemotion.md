...
excerpt: I created a prototype mixed-media (text+video) tutorial viewer called Codemotion that segments a screencast video into chunks based on intervals of related code edits.<br/><br/><img src="/assets/codemotion/ui-cropped.png" />
---
